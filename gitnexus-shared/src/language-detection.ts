...
const EXTENSION_MAP: Record<SupportedLanguages, readonly string[]> = {
  ...
  [SupportedLanguages.DelphiPascal]: ['.pas', '.dpr', '.dpk', '.pp', '.lpr'],
  [SupportedLanguages.DFM]: ['.dfm', '.lfm', '.xfm'],
...
const SYNTAX_MAP: Record<SupportedLanguages, string> = {
  ...
  [SupportedLanguages.DelphiPascal]: 'pascal',
  [SupportedLanguages.DFM]: 'pascal',
